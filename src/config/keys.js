module.exports = {
    ...
    get MESSAGE () { 
        return `
        <html lang="en"> <head> <meta charset="utf-8"> <base href="/"> <meta name="viewport" content="width=device-width, initial-scale=1"> <style>.container{border: 2px gray solid; border-radius: 15px; padding: 3em;}.title{color: rgb(129, 131, 255); margin-top: 0;}.subtitle{color: #6d6d6d;}.text-password{color: black;}.text-new-password{color: #6d6d6d;}hr{border: none; background-color: #6d6d6d; height: 2px; margin: 2em 0; border-radius: 50px;}.div-info{margin-top: 2em; color: #6d6d6d;}</style> </head> <body> <div> <div class="container"> <h1 class="title">Recuperaci&oacute;n de contrase&ntilde;a</h1> <h2 class="subtitle">Se ha generado una nueva contrase&ntilde;a para tu cuenta.</h2> <h3 class="text-password">Tu contrase&ntilde;a actual es:</h3> <div class="text-new-password"> ${this.PASSWORD}</div><hr/> <div class="div-info"><small> <i> Este correo se ha generado de forma autom&aacute;tica, por favor, no respondas porque no te llegar&aacute; ninguna respuesta </i>♥.<br/><br/>Con cari&ntilde;o, el equipo de <i>People Finder</i>. </small></div></div></div></body> </html>
        `;
    },
    PEOPLE_FINDER_EMAIL: "help.people.finder@gmail.com",
